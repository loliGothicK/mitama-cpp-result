...
//
#ifndef ETUDE_UTILITY_INCLUDED_POINTEE_NOT_EQUAL_HPP_
#define ETUDE_UTILITY_INCLUDED_POINTEE_NOT_EQUAL_HPP_
...
#include "../functional/not_equal_to.hpp"

namespace etude {

  template< class T, class U, class Comp = etude::not_equal_to<>,
    ...
    >::type
  >
  inline bool pointee_not_equal( T const& lhs, U const& rhs, Comp && comp = Comp() ) {
    return lhs ? ( rhs ? bool( comp( *lhs, *rhs ) ) : true ) : ( rhs ? true : false );
  }

} // namespace etude

#endif  // #ifndef ETUDE_UTILITY_INCLUDED_POINTEE_NOT_EQUAL_HPP_
